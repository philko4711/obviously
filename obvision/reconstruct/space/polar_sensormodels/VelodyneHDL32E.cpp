...
VelodyneHDL32E::VelodyneHDL32E(unsigned int raysIncl, double inclMin, double inclMax, double inclRes, double azimMin, double azimMax, double azimRes, std::vector<int> firingSeq)
    : SensorPolar(raysIncl, inclMin, inclMax, inclRes, azimMin, azimMax, azimRes, firingSeq)
{
